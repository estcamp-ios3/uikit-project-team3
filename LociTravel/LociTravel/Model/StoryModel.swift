...
let dialogues_Museum: [(speaker: String, line: String)] = [
    ...
    ("", "그때, 두 사람에게 낯선 그림자가 드리워졌다. 검은 복면을 쓴 한 사내가 재빠르게 서동에게 다가와 그의 목걸이를 낚아채 달아났다."),
    ("서동", "아앗! 내 목걸이!"),
    ("선화", "잠깐만요! 저 목걸이는…!"),
    ...
    ("", "서동은 자신의 목걸이를, 선화는 예언의 조각을 되찾기 위해 함께 도둑을 뒤쫓기 시작했다. 서로 다른 이유였지만, 두 사람의 발걸음은 하나의 운명을 향해 나아가고 있었다."),
    ("서동", "도대체 왜 제 목걸이를 훔쳐간 걸까요? 그냥 낡은 쇠붙이에 불과한데…."),
    ("선화", "서동님, 제 목걸이도 비슷한 모양을 하고 있어요. 어쩌면 그 도둑은 단순히 쇠붙이가 아닌, 이 목걸이 조각이 가진 비밀을 노리고 있는지도 몰라요."),
    ("", "서동은 선화의 말에 자신의 목걸이가 단순한 유품이 아닐지도 모른다는 생각을 품게 되었다. 그들의 눈앞에 펼쳐질 새로운 진실의 서막이 서서히 드러나고 있었다. 그리고 도둑은 미륵사지 방향으로 달아나고 있었다.")
]
...
let dialogues_Temple: [(speaker: String, line: String)] = [
    ...
    ("고승", "결국 운명이 이곳으로 이끌었군요."),
    ("내레이션", "백발의 고승이 모습을 드러냈다. 그는 서동과 선화의 손에 들린 목걸이 조각을 번갈아 보며 잔잔한 미소를 지었다."),
    ("고승", "귀빈들의 목걸이는 단순한 장신구가 아니다. 먼 옛날, 고조선의 마지막 왕 준왕의 염원이 담긴 예언의 조각입니다."),
    ("선화", "예언…?"),
    ("고승", "그렇습니다. 이 목걸이 조각에 새겨진 글을 읽어보도록 하겠습니다."),
    ("", "고승은 서동의 목걸이를 들고 천천히 읽어내려갔다."),
    ("고승", "王者非血繼之者也... '왕이란 피를 잇지 않은 자가 되려 한다.'"),
    ("서동", "왕이… 피를 잇지 않은 자라고요…? 그게 무슨… 말도 안 되는…."),
    ("", "얼핏 들으면 반역을 꾀하는 것처럼 들리는 말에 서동은 충격에 휩싸였다. 그의 머릿속은 혼란으로 가득 찼다."),
    ("고승", "선화 공주의 목걸이에 적힌 글은 이것입니다.. 太平之世將至之信... '평화의 시대가 도래할 것이란 우리들의 믿음'"),
