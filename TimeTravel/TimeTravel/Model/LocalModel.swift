...
class LocalModel {
    ...
    public func getThemeData(localName: String, themeName: String) -> Theme {
        return innerThemeData.filter{ $0.local == localName && $0.theme == themeName }.first ?? innerThemeData[0]
    }
}
